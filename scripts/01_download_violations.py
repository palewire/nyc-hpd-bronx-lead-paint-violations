...
# Order numbers to keep per HPD data dictionary and site
ORDER_NUMBERS = ["555", "616", "617", "624"]

# The open violation status
...
where = (
    ...
    f"AND violationstatus='{VIOLATION_STATUS}' "
...
print(
    "Downloading open Bronx lead paint violations from NYC Open Data (paginating) ..."
)
